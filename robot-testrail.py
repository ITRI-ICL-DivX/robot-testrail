...
def main():
	...
	testrail_url = "https://172.18.51.100/testrail/"
        ...
        testrun = "This is a new test run"

	try:

		opts, args = getopt.getopt(sys.argv[1:], "",["pid=","testrun=", "folder=", "user=", "pwd=", "testrail="])
	...
	run = client.send_post('add_run/' + str(projectid), 
		...
		{"suite_id": 1,"name":testrun,"assignedto_id": 1,"include_all": 	"1"})
